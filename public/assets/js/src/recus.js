                ...
                for(i in recu){
                    ...
                    if(res.type == "devmaster"){
                        ...
                        if(recu[i].annul_recu == 1){
                            tr += '<tr class="'+cls+'"><td>'+(parseInt(i)+1)+'</td><td>'+recu[i].NIE+'</td><td>'+recu[i].nom+'</td><td>'+recu[i].prenom+'</td><td>'+(recu[i].nom_niv+""+recu[i].nom_gp)+'</td><td class="text-center">'+($.date(new Date(recu[i].date_p)))+'</td><td>'+format(parseFloat(recu[i].montant).toFixed(2))+' Ar</td><td>'+format(parseFloat(recu[i].reste).toFixed(2))+' Ar</td><td>'+recu[i].mode+'</td><td class="d-flex justify-content-around flex-lg-row flex-column"></td></tr>';
                        }else{
