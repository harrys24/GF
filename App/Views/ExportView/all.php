...
<div class="container-fluid pt-md-5 pt-lg-0">
  <form id="form-export" action="/export/all_student" method="post" class="row">
    ...
    <div class="dropdown col-12 col-md-5 col-lg-2 my-2">
      ...
      <div id="cnp" class="dropdown-menu">
        <button type="button" class="dropdown-item" n=-1>Tous</button>
        <?php foreach ($niv as $item) { ?> 
        <button type="button" class="dropdown-item" n=<?php echo $item['idNIV']; ?>><i id="niv_ico"></i><?php echo $item['nom_niv']; ?></button>
        <?php } ?>
      </div>
    </div>
